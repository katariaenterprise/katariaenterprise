      ...
      <div className="container mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <AnimatedSection delay={0.2}>
            ...
            <h3 className="font-heading font-bold text-3xl text-foreground mb-4 leading-snug">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={s.label} className="bg-secondary border border-border rounded-xl p-5 text-center hover-lift">
